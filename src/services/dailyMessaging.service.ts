                ...
                messages: [
                    {
                        ...
                        Смотри на последние сообщения пользователя и выбери из них случайную тему. 
                        Составь только один короткий вопрос в разговорном стиле, как будто ты общаешься с другом. 

                        Формат вопроса:
                        - Начало с отсылкой к сообщению пользователя ("Ты говорил(а) про ...", "Помню, ты писал(а) ...", "Ты упоминал(а) ..."). 
                        - Потом задай уточняющий или естественный вопрос ("... Удалось съездить?", "... Как у тебя с этим сейчас?", "... Ты доволен результатом?"). 

                        Правила:
                        - Вопрос должен звучать легко и по-дружески, побуждать к ответу. 
